...
if ($ret) {
    ...
    $to = 'director.general@mnm.punjab.gov.pk, mansoorjalap@gmail.com, padgmm@punjab.gov.pk, engr.irfan641@gmail.com, mit.dgmm@punjab.gov.pk, diradmn.dgmm@punjab.gov.pk, manageritpunjab@gmail.com';
    $subject = 'Attendance Report for ' . date('d-m-Y');

    // $headers  = "From: " . strip_tags($_POST['req-email']) . "\r\n";
    $headers = "Reply-To: mit.dgmm@punjab.gov.pk\r\n";
